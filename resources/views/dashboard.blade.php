...
<div class="container">
    ...
    <div class="container mt-5">
        <h3>Upload Files</h3>
        <form id="addForm" method="post" action="{{route('uploadPrivate')}}" enctype="multipart/form-data">
            <div class="mb-3">
                <input multiple data-max-file-size="100MB" data-max-files="100" type="file" name="file" id='file' class='p-5'>
            </div>
            <div class="mb-3">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col" class="col-sm-2 text-center">Share</th>
        </tr>
        </thead>
        <tbody>
...
{{--                    </button>--}}
                ...
                <script>
                    function copyToClipboard() {
                        document.getElementById("copy_{{ $file->id }}").select();
                        document.execCommand('copy');
                    }
                </script>
                <td class="col-sm-2 text-center">
                    <form  action="{{ url('urlGen/'.$file->id) }}" method="post"
                          id="delform{{ $file->id }}">
                        @csrf
                        <button class="btn btn-primary" type="submit">
