...
<div class="container">
    <div class="container bg-info my-3 fs-5 px-4 py-2 text-light">
        DuTiSa's Public Drive
    </div>
    <div class="container">
        <div class="m-2">Upload New Files</div>
        <hr class="border border-primary border-1 opacity-75">
        <form class="d-flex flex-column align-items-start gap-2" action="/uploadPublic" method="post"
                    ...
                    <tr>
                        ...
                        <td class="col-sm-2 text-center">
                            <form action="{{ url('/downloadPublic/' . $file->id) }}" method="post"
                                ...
                                @csrf
                                <a href="javascript:$('#downloadform{{ $file->id }}').submit();"
                                   type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
