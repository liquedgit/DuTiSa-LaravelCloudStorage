...
<h2 class="card-title text-center">DuTiSa's Public Drive</h2>
...
<table class="table caption-top" id="table">
    ...
    @foreach ($files as $file)
        <tr>
            ...
            {{--                <td>{{$file->}}</td>--}}
            <td>
                <form action="/downloadPublic/{{$file->id}}" method="post" id="downloadform{{$file->id}}">
                    @csrf
                    {{-- <button type="submit"> --}}
            ...
            <td>
                <form action="/deletePublic/{{$file->id}}" method="post" id="delform{{$file->id}}">
                    @csrf
...
<div class="main">
    ...
    <div class="d-flex justify-content-around">
        <form action="/uploadPublic" method="post" enctype="multipart/form-data">
            @csrf
            <div id="box">
