                        ...
                        <tr>
                            ...
                            <td class="col-sm-2 text-center">
                                <form action="<?php echo e(url('/delete/' . $file->id)); ?>" method="post"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <a href="javascript:$('#delform<?php echo e($file->id); ?>').submit();" type="submit">
                            ...
                            <td class="col-sm-2 text-center">
                                <form action="<?php echo e(url('/download/' . $file->id)); ?>" method="post"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <a href="javascript:$('#downloadform<?php echo e($file->id); ?>').submit();"
                                        type="submit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<?php /**PATH C:\Users\jerem\OneDrive\Desktop\DuTiSa-LaravelCloudStorage-main\resources\views//dashboard.blade.php ENDPATH**/ ?>