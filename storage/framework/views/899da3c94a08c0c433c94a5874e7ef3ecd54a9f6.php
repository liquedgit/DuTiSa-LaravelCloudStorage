...
<div class="login-form card position-absolute top-50 start-50 translate-middle">
    ...
    <form method="post" action="<?php echo e(url('/registerpage')); ?>" class="my-3">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
    ...
    <div class="mb-3">
        Already have an account?? <a href="<?php echo e(url('/logindirect')); ?>">Login</a>
    </div>
    <?php if($errors->any()): ?>
...
<?php /**PATH D:\Work\Github\DuTiSa-LaravelCloudStorage\resources\views//auth/register.blade.php ENDPATH**/ ?>